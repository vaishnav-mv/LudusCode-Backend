...
export class AdminController {
   ...
   */
  subscriptionData = asyncHandler(async (req: Request, res: Response) => {
    const page = parseInt(req.query.page as string) || 1
    const limit = parseInt(req.query.limit as string) || 50
    ...
    const data = await this._service.subscriptionData(page, limit, { action, sortStr, sortOrder, query })
   ...
   * @res     { ok: boolean }
   */
  approveProblem = asyncHandler(async (req: Request, res: Response) => {
   ...
   */
  allProblems = asyncHandler(async (req: Request, res: Response) => {
    const page = parseInt(req.query.page as string) || 1
    const limit = parseInt(req.query.limit as string) || 50
   ...
   */
  allUsers = asyncHandler(async (req: Request, res: Response) => {
    const page = parseInt(req.query.page as string) || 1
    const limit = parseInt(req.query.limit as string) || 50
   ...
   * @res     [FlaggedUser]
   */
  flaggedActivities = asyncHandler(async (req: Request, res: Response) => {
    const page = parseInt(req.query.page as string) || 1
    const limit = parseInt(req.query.limit as string) || 50
   ...
   * @res     [Duel]
   */
  monitoredDuels = asyncHandler(async (req: Request, res: Response) => {
    const page = parseInt(req.query.page as string) || 1
    const limit = parseInt(req.query.limit as string) || 50
   ...
   * @res     { ok: boolean }
   */
  forceDuelResult = asyncHandler(async (req: Request, res: Response) => {
   ...
   */
  getUserWallet = asyncHandler(async (req: Request, res: Response) => {
