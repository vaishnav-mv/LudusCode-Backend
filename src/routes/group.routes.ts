...
export class GroupRoutes {
    ...
    private setupRoutes() {
        ...
        this.router.post('/:id/join', validate(GroupMemberActionSchema), (req, res, next) => this._controller.joinGroup(req, res).catch(next))
        this.router.post('/:id/leave', validate(GroupMemberActionSchema), (req, res, next) => this._controller.leaveGroup(req, res).catch(next))
